...
import robertImg from '@/assets/team/robert-chimbiti.jpg';
import godwinImg from '@/assets/team/godwin-bhinzi.jpg';
import nyashaImg from '@/assets/team/nyasha-jappie.jpg';

const team = [
  {
    name: 'Robert Chimbiti',
...
export default function Leadership() {
  const ref = useScrollAnimation<HTMLDivElement>({ childSelector: '.team-card', stagger: 0.15 });

  return (
    <section id="about" className="section-padding bg-background">
      <div className="section-container">
        <div className="text-center max-w-2xl mx-auto mb-6">
          <span className="text-accent font-semibold text-sm uppercase tracking-widest mb-3 block">Our Team</span>
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">
            Leadership You Can Trust
          </h2>
          <p className="text-muted-foreground text-lg">
            Founded in 2014, Peter Field Technologies is dedicated to bringing enterprise-grade IT solutions to Zimbabwe.
          </p>
        </div>
        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-8">
          {team.map((member) => (
            <div key={member.name} className="team-card bg-card rounded-xl overflow-hidden border border-border card-hover text-center">
